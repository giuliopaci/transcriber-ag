...
static struct _iso639_def {
	...
	{"gsw", "", "Swiss German; Alemannic", "alémanique"},
...
{ 
	...
	for ( i=0; codes_list[i].code_3 != NULL; ++i ) { 
	    if ( strcmp(codes_list[i].code_2, two_letter_code) == 0 ) 
			return codes_list[i].code_3;	
	}
	return "";
}
...
{ 
	...
	for ( i=0; codes_list[i].code_3 != NULL; ++i ) { 
	    if ( strcmp(codes_list[i].code_3, three_letter_code) == 0 ) 
			return codes_list[i].code_2;	
	}
	return "";
}
...
const char* getLanguageName(const char* three_letter_code, const char* locale)
{
	...
	for ( i=0; codes_list[i].code_3 != NULL; ++i ) { 
	    if ( strcmp(codes_list[i].code_3, three_letter_code) == 0 ) 
			if ( strcmp(locale, "fre") == 0 ) return  codes_list[i].name_fre;
