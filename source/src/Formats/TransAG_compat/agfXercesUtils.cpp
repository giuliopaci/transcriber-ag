...
void tagSAXParse(HandlerBase* handler,
		 ...
		 const string& encoding)
{
  ...
  parser.setEntityResolver(handler);
   ...
   parser.parse(inputSrc);
  	...
  	throw agfio::LoadError("Unknown exception in tagSAXParse: id already exists ?? ");
	}
}


void tagSAXParseBuffer(HandlerBase* handler,
		 const string& xml_buffer,
		 const bool& xml_validation,
		 const string& encoding)
{
	MemBufInputSource inputSrc((const XMLByte*)(xml_buffer.c_str()), xml_buffer.size(), trans(""));
