...
* $Id$
*
* HTMLfile.h: VS Fast Transcription file format class implementation
*/


#include "HTMLfile.h"

string HTMLfile::nomatch("");
...
HTMLfile::HTMLfile(const string& filename)
: Record(1)
{
  open(filename);
  init();
